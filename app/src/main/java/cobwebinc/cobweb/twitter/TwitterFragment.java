...
public class TwitterFragment extends Fragment{
    ...
    public static TwitterFragment newInstanse(Status status){
        ...
        bundle.putString("image_url", status.getUser().getBiggerProfileImageURL());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        hashNameTextView.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
        timeTextView.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
        nameTextView.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
